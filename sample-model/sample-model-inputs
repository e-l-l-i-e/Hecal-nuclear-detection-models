...
#return 1: create xml files of materials, geometry, tallies, and settings
openmc.run()

#return 2: visualize geometry
...
sp = openmc.StatePoint('statepoint.100.h5')  # filename depends on batch count
tally = sp.get_tally(scores=['flux'])
df = tally.get_pandas_dataframe()
df.plot(x='flux', y='mean', yerr='std. dev.', kind='bar')
plt.show()
